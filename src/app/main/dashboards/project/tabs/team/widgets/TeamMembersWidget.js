        ...
        >
          <div className="flex flex-col flex-auto w-full p-32 text-center">
            <div className="w-128 h-128 mx-auto rounded-full overflow-hidden">
              <img className="w-full h-full object-cover" src={member.images[0]} alt="member" />
            </div>
            <Typography className="mt-24 font-medium">{member?.NameOfProperty}</Typography>
            <Typography color="text.secondary">{member.category}</Typography>
          </div>
